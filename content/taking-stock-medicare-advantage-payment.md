...
**Sources**: Commonwealth Fund, ["Taking Stock of Medicare Advantage Payment"](https://www.commonwealthfund.org/blog/2022/taking-stock-medicare-advantage-payment) (2022)
...
**MedPAC's estimates**: The Medicare Payment Advisory Commission has consistently found that Medicare spends more per beneficiary in MA than it would if those same people were in traditional Medicare. Their estimates have ranged from 4–6% excess spending annually — amounting to tens of billions of dollars per year.
...
**Coding intensity**: MA plans invest heavily in [[risk-adjustment-coding|HCC coding optimization]] — in-home assessments, chart reviews, retrospective coding programs. This systematically inflates risk scores relative to traditional Medicare, where coding only reflects what appears in claims. CMS applies a coding intensity adjustment to account for this, but researchers debate whether it fully corrects for the gap.

## The Reform Debate

There is bipartisan concern about MA overpayment, but the politics are complicated:

**The case for reform**: Federal spending on MA is projected to grow substantially as enrollment increases. If plans are overpaid, reducing payments would save money without reducing benefits — in theory.

**The resistance to reform**: MA plans use their higher-than-FFS payment to fund supplemental benefits (dental, vision, hearing, transportation) that beneficiaries value. Cutting MA rates would pressure plans to reduce these benefits or exit markets. With ~half of Medicare beneficiaries now in MA, this is politically sensitive.

**Plan response to rate cuts**: When CMS has implemented rate reductions or slowed benchmark growth, some plans have exited markets, reduced benefits, or increased premiums. CMS must balance payment accuracy against plan stability and beneficiary access.

## Recent Developments

In 2023–2024, CMS implemented a series of rate-setting changes that reduced MA payment growth below plan expectations. Several large insurers (Humana, CVS/Aetna, UnitedHealth) reported significant MA profitability pressure and scaled back in certain markets. This is explored further in [[6-insights-on-the-new-ma-reality]].
