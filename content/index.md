...
*How Americans get health insurance — from employer plans to government programs to the uninsured.*

| Page | Description |
|---|---|
| [[employer-based-insurance]] | The largest source of coverage (~156M Americans); self-insurance, ERISA, ACA employer mandate, 2026 outlook |
| [[affordable-care-act]] | The 2010 reform law: Marketplaces, Medicaid expansion, consumer protections, subsidy structure, and 2026 status |
...
*The U.S. spends more on healthcare than any other country and gets less for it. These pages explain where the money goes and why costs keep rising.*

| Page | Description |
|---|---|
| [[healthcare-costs]] | Scale of U.S. spending, who worries about it, trends driving cost growth, and policy responses in 2026 |
| [[pharmacy]] | Prescription drug spending, GLP-1 surge, specialty biologics, PBM reform, federal drug pricing policy, and distribution model shifts |
...
| Page | Description |
|---|---|
| [[uninsured]] | ~26–28M uninsured in 2024; who they are, how they get care, and the OBBBA's projected impact of 10M more |
| [[health-equity]] | Racial, income, and geographic health disparities; social determinants of health; shift from reporting to action in 2026 |
| [[rural-health]] | Provider shortages and hospital fragility in rural areas; OBBBA's $50B Rural Health Transformation Program |

## Market Structure

*Healthcare is also an industry. These pages cover the business dynamics — who owns what, how markets are concentrated, and the new wave of care platform companies.*

| Page | Description |
|---|---|
| [[healthcare-consolidation]] | How hospital and insurer markets became highly concentrated; pricing consequences; 2026 policy responses |
| [[price-transparency]] | Federal price disclosure rules, their limited practical impact so far, and the bipartisan push for stronger transparency in 2026 |
| [[breaking-down-care-platform-landscape]] | Who MSOs and care platform operators are, how they make money, and why the space is consolidating around scale |
